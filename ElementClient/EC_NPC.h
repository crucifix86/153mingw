...
public:		//	Operations
	...
	//	Tick routine
	bool TickBeforeAnimate(DWORD dwDeltaTime);
	bool TickOnlyAnimation(DWORD dwDeltaTime);
	virtual bool TickAfterAnimate(DWORD dwDeltaTime);
	...
	void SetHighligh(bool value) { m_bHighlight = value; }
	...
	bool IsRenderingTaskGFX() const { return m_bRenderingTaskGFX; }
	void SetRenderingTaskGFX(bool flag) { m_bRenderingTaskGFX = flag; }

	bool IsRequiredForTask() const { return m_bRequiredForTask; }
	void SetRequiredForTask(bool flag) { m_bRequiredForTask = flag; }
	...
	*/
	...
	void PlayGfx(const char* szPath, const char* szHook);
...
protected:	//	Attributes
	...
	bool			m_bHighlight;		//	Enable / Disable Highligh NPC Model
	...
	DWORD			m_dwTickIconCountdown;		//	Icon state tick countdown
	...
	bool			m_bRequiredForTask; // Activate signal for start renders GFX
	bool			m_bRenderingTaskGFX; // Render highlight when tasks is available for npc
	...
	CECPolicyAction *	m_pPolicyAction;	//	���Զ���
	DWORD	m_nPolicyActionIntervalTimer;	//	���Զ������ż����ʱ���������Զ�����NPCģ���ϴ���ʱ�����ã�
	...
	int				m_idOwnerFaction;	//	NPC �����İ��ɣ�����PVP�п�NPC��ʹ�ã�
