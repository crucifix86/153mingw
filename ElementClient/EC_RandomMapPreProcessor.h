...
protected:
		...
		abase::vector<int> borderBlock[NUM_BORDER]; // �߽�block
...
//	abase::hash_map<int,A3DVECTOR3> m_teamMemLastPos; // ���ѵ��ϴ�λ��
};
...
public:
	...
	void GenerateMinimapImage(abase::vector<A3DSurface*>& srcImgVec, const AString& path, const AString& fileName);
