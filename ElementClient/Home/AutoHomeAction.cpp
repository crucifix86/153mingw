...
bool CAutoHomeAction::DoHillActions()
{
	...
	// Do hill poly
	for (int i=0; i<=m_nHillPolyNodePos; i++)
	{
	...
	// Do hill line
	for (int i=0; i<=m_nHillLineNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nPartTextureNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nRoadNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nForestPolyNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nForestLineNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nGrassPolyNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nBuildingNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nTerrainFlatNodePos; i++)
	{
...
{
	int i;
	for (int i=0; i<=m_nLightNodePos; i++)
	{
...
bool CAutoHomeAction::CreateLightActions(CAutoLight* pLight)
{
	...
	int i;
	for (int i=0; i<pLightData->GetSize(); i++)
	{
		if (!AddActionLight(
...
bool CAutoHomeAction::CreateBuildingActions()
{
	...
	int i;
	MODELSTATUS status;
	for (int i=0; i<pAutoBuilding->GetNumBuildings(); i++)
	{
