...
void CECRTDebug::InitPNameMap()
{
	...
	mProtocol[10000] = "PROTOCOL_SETLOCKEDLOGOUTUSER";
...
void CECRTDebug::InitCGNameMap()
{
	...
	mCGamedata[181]	= "SOLO_CHALLENGE_OPERATE_REQUEST";
	mCGamedata[184]	= "PICKUP_ALL";
	mCGamedata[185]	= "FIX_POSITION_TRANSMIT_OPERATE_REQUEST";
	mCGamedata[186]	= "REMOTE_REPAIR";
	mCGamedata[186]	= "REMOTE_REPAIR";
	mCGamedata[187]	= "GET_CASH_VIP_MALL_ITEM_PRICE";
	mCGamedata[188] = "CASH_VIP_MALL_SHOPPING";
...
void CECRTDebug::InitSGNameMap()
{
	...
	mSGamedata[397] = "ASTROLABLE_INFO_NOTIFY";
	mSGamedata[398] = "ASTROLABE_OPERATE_RESULT";
	mSGamedata[399] = "SOLO_CHALLENGE_AWARD_INFO_NOTIFY";
	mSGamedata[400] = "SOLO_CHALLENGE_OPERATE_RESULT";
	mSGamedata[401] = "SOLO_CHALLENGE_CHALLENGING_STATE_NOTIFY";
	mSGamedata[402] = "SOLO_CHALLENGE_BUFF_INFO_NOTIFY";
	mSGamedata[416] = "FIX_POSITION_TRANSMIT_ADD_POSITION";
	mSGamedata[417] = "FIX_POSITION_TRANSMIT_DELETE_POSITION";
	mSGamedata[418] = "FIX_POSITION_TRANSMIT_RENAME";
	mSGamedata[419] = "FIX_POSITION_ENERGY_INFO";
	mSGamedata[420] = "FIX_POSITION_ALL_INFO";
	mSGamedata[422] = "CASH_VIP_MALL_ITEM_BUY_RESULT";
	mSGamedata[423] = "CASH_VIP_INFO_NOTIFY";
	mSGamedata[424] = "PURCHASE_LIMIT_INFO_NOTIFY";
	mSGamedata[425] = "LOOKUP_ENEMY_RESULT";
	mSGamedata[426] = "CASH_RESURRECT_INFO";
	mSGamedata[425] = "LOOKUP_ENEMY_RESULT";
	mSGamedata[426] = "CASH_RESURRECT_INFO";
	mSGamedata[428] = "ARENA_QUEUE_NOTIFICATION";
	mSGamedata[429] = "ARENA_QUEUE_CANCEL";
	mSGamedata[430] = "ARENA_QUEUE_CONFIRM_BATTLE";
#endif
}
