...
bool CFaceBoneController::LoadBonePartInfo(const char* szFile)
{
	...
	int nCount, nIndex;
	int i, j;
	for (int i=0; i<BONE_PART_COUNT; i++)
	{
...
void CFaceBoneController::RemoveSelection(int nSelIndex)
{
	...
	int i;
	for (int i=nSelIndex; i<m_nSelectedCount - 1; i++)
	{
...
void CFaceBoneController::SelectBoneGroup(int nIndex)
{
	...
	int i;
	for (int i=0; i<m_BoneGroup[nIndex].GetSize(); i++)
	{
...
// Translate bone
bool CFaceBoneController::TranslateBone(const A3DVECTOR3& vector, bool bUpdate, bool bHalfFace)
{
	int i, nIndex;
	bool bEdit = false;
	for (int i=0; i<m_nSelectedCount; i++)
...
// Rotate Bone
bool CFaceBoneController::RotateBone(const A3DVECTOR3& v, CENTERTYPE type, bool bUpdate, bool bHalfFace)
{
	int i, nIndex;
	A3DVECTOR3 vCenter;
	bool bEdit = false;
...
// Scale bone
bool CFaceBoneController::ScaleBone(const A3DVECTOR3& v, CENTERTYPE type, bool bUpdate, bool bHalfFace)
{
	int i, nIndex;
	A3DVECTOR3 vCenter;
	bool bEdit = false;
...
// Scale eyeball
bool CFaceBoneController::ScaleEyeball(const A3DVECTOR3& vScale, bool bUpdate, EDITSCOPE scope)
{
	A3DVECTOR3 vCenter;
