...
public:
	 ...
	 */
	// Translate bone
	bool TranslateBone(const A3DVECTOR3& vector, bool bUpdate, bool bHalfFace);
	// Rotate bone
	bool RotateBone(const A3DVECTOR3& v, CENTERTYPE type, bool bUpdate, bool bHalfFace);
	// Scale bone
	bool ScaleBone(const A3DVECTOR3& v, CENTERTYPE type, bool bUpdate, bool bHalfFace);
	// Update bone
	...
	// Scale eyeball
	bool ScaleEyeball(const A3DVECTOR3& vScale, bool bUpdate, EDITSCOPE scope);
