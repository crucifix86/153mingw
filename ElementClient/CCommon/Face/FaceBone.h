...
public:
	// Translate bone
	void Translate(const A3DVECTOR3& v);
	// Rotate bone
	void Rotate(const A3DVECTOR3& vPos, const A3DVECTOR3& vRad);
	// Scale bone
	void Scale(const A3DVECTOR3& vPos, const A3DVECTOR3& v);
	// Update bone
...
//	void StoreShapeTM();
	...
	inline void SetTransformMatrix(const A3DMATRIX4& m) { m_TM = m; }
	inline A3DMATRIX4& GetOldTM() { return m_OldTM; }
	inline void SetOldTM(const A3DMATRIX4& m) { m_OldTM = m; }
	inline void SetPos(const A3DVECTOR3& vector) { m_vPosition = vector; }
	...
	inline void SetShapeTM(const A3DMATRIX4& m) { m_ShapeTM = m; }
