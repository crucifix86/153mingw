...
// Translate bone
void CFaceBone::Translate(const A3DVECTOR3& v)
{
	A3DMATRIX4 m;
...
// Rotate bone
void CFaceBone::Rotate(const A3DVECTOR3& vPos, const A3DVECTOR3& vRad)
{
	A3DMATRIX4 m;
...
// Scale bone
void CFaceBone::Scale(const A3DVECTOR3& vPos, const A3DVECTOR3& v)
{
	A3DMATRIX4 m;
