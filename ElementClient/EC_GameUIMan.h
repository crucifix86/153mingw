...
// Forward declarations for dialog classes
class CDlgAction; class CDlgActivity; class CDlgArenaCountTime; class CDlgArenaMessage;
class CDlgArenaPoint; class CDlgArenaQueue; class CDlgArenaQueueChoose; class CDlgArenaResult;
class CDlgArrangeTeam; class CDlgAskHelpToGM; class CDlgAskHelpToGM2; class CDlgAstrolabe;
class CDlgAstrolabeIncPointValue; class CDlgAstrolabeRandomAddon; class CDlgAstrolabeSwallow;
class CDlgAuctionBase; class CDlgAuctionBuyList; class CDlgAuctionList; class CDlgAuctionSearch;
class CDlgAuctionSellList; class CDlgAutoHelp; class CDlgAutoHPMP; class CDlgAutoLock;
class CDlgAutoMove; class CDlgAutoPolicy; class CDlgAutoTask; class CDlgAward;
class CDlgBackHelp; class CDlgBackOthers; class CDlgBackSelf; class CDlgBag; class CDlgBBS;
class CDlgBlackList; class CDlgBlackScreen; class CDlgBoothElse; class CDlgBoothSelf;
class CDlgBoothSet; class CDlgBroadCast; class CDlgBShop; class CDlgBuddyState;
class CDlgBuyConfirm; class CDlgCamera; class CDlgChangeEqp; class CDlgChangeSkirt;
class CDlgChannelChat; class CDlgChannelCreate; class CDlgChannelJoin; class CDlgChannelOption;
class CDlgChannelPW; class CDlgCharacter; class CDlgChariotAmount; class CDlgChariotEnter;
class CDlgChariotInfo; class CDlgChariotMultiKill; class CDlgChariotOpt; class CDlgChariotRankList;
class CDlgChariotRevive; class CDlgChariotScore; class CDlgChat; class CDlgColorName;
class CDlgComboShortCutBar; class CDlgComplexTitle; class CDlgConsole; class CDlgCountryMap;
class CDlgCountryReward; class CDlgCountryScore; class CDlgCountryWarMap; class CDlgCWindow;
class CDlgDamageRep; class CDlgDomainCondition; class CDlgDoubleExp; class CDlgDoubleExpS;
class CDlgDownloadSpeed; class CDlgDragDrop; class CDlgEarthBagRank; class CDlgELFEquipRemove;
class CDlgELFGenius; class CDlgELFGeniusReset; class CDlgELFInExp; class CDlgELFLearn;
class CDlgELFProp; class CDlgELFRefine; class CDlgELFRefineTrans; class CDlgELFRetrain;
class CDlgELFSkillTree; class CDlgELFToPill; class CDlgELFTransaction; class CDlgELFXiDian;
class CDlgEnemyTeamMate; class CDlgEngrave; class CDlgEPEquip; class CDlgEquipAccessorySlot;
class CDlgEquipBind; class CDlgEquipDestroy; class CDlgEquipDye; class CDlgEquipMark;
class CDlgEquipRefine; class CDlgEquipSlot; class CDlgEquipUndestroy; class CDlgEquipUp;
class CDlgEquipUpEnsure; class CDlgExclusiveAward; class CDlgExit; class CDlgExp;
class CDlgExplorer; class CDlgFaceLift; class CDlgFactionPVPRank; class CDlgFactionPVPStatus;
class CDlgFashionShop; class CDlgFashionShopItem; class CDlgFashionSplit; class CDlgFindPlayer;
class CDlgFittingRoom; class CDlgFlySwordImprove; class CDlgFortressBuild;
class CDlgFortressBuildSub; class CDlgFortressBuildSubList; class CDlgFortressContrib;
class CDlgFortressExchange; class CDlgFortressInfo; class CDlgFortressMaterial;
class CDlgFortressMini; class CDlgFortressStatus; class CDlgFortressWar;
class CDlgFortressWarList; class CDlgFriendChat; class CDlgFriendColor; class CDlgFriendGroup;
class CDlgFriendHistory; class CDlgFriendList; class CDlgFriendOptionGroup;
class CDlgFriendOptionName; class CDlgFriendOptionNormal; class CDlgFriendRequest;
class CDlgGenCardCollection; class CDlgGenCardRespawn; class CDlgGeneralCard;
class CDlgGeneralCardBuy; class CDlgGeneralCardBuySetting; class CDlgGiftCard;
class CDlgGivingFor; class CDlgGMConsole; class CDlgGMConsoleForbid; class CDlgGMDelMsgReason;
class CDlgGMFinishMsg; class CDlgGMParam; class CDlgGMQueryItem; class CDlgGodEvilConvert;
class CDlgGoldAccount; class CDlgGoldInquire; class CDlgGoldPassword; class CDlgGoldTrade;
class CDlgGuildCreate; class CDlgGuildDiplomacyApply; class CDlgGuildDiplomacyMan;
class CDlgGuildMan; class CDlgGuildMap; class CDlgGuildMapStatus; class CDlgGuildMapTravel;
class CDlgHelp; class CDlgHost; class CDlgHostELF; class CDlgHostPet; class CDlgIceThunderBall;
class CDlgIdentify; class CDlgInfo; class CDlgInputName; class CDlgInputNO; class CDlgInstall;
class CDlgInventory; class CDlgInvisibleList; class CDlgKingAuction; class CDlgKingCommand;
class CDlgKingElection; class CDlgKingResult; class CDlgLinked; class CDlgMailList;
class CDlgMailOption; class CDlgMailRead; class CDlgMailToFriends; class CDlgMailWrite;
class CDlgMarkVip; class CDlgMatchInfoHint; class CDlgMatchModeSelect; class CDlgMatchProfileAge;
class CDlgMatchProfileHabit; class CDlgMatchProfileHobby; class CDlgMatchProfileSetting;
class CDlgMatchResult; class CDlgMeridians; class CDlgMeridiansImpact; class CDlgMessageBox;
class CDlgMiniMap; class CDlgModifyName; class CDlgNewTransport; class CDlgNPC;
class CDlgOfflineShopCreate; class CDlgOfflineShopItemsList; class CDlgOfflineShopList;
class CDlgOfflineShopSelfSetting; class CDlgOfflineShopStore; class CDlgOfflineShopType;
class CDlgOnlineAward; class CDlgOnlineRemind; class CDlgOptimizeBase; class CDlgOptimizeMem;
class CDlgPalette; class CDlgPalette2; class CDlgPetDetail; class CDlgPetDye;
class CDlgPetEvoAnim; class CDlgPetEvolution; class CDlgPetFittingRoom; class CDlgPetHatch;
class CDlgPetList; class CDlgPetNature; class CDlgPetRec; class CDlgPetRename;
class CDlgPetRetrain; class CDlgPKSetting; class CDlgPlantPet; class CDlgPopMsg; class CDlgPQ;
class CDlgPreviewPetRebuild; class CDlgPreviewProduce; class CDlgProclaim; class CDlgProduce;
class CDlgProfView; class CDlgPureColorFashionTip; class CDlgQShop; class CDlgQShopBuy;
class CDlgQShopItem; class CDlgQuestion; class CDlgQuestionTask; class CDlgQuickAction;
class CDlgQuickBar; class CDlgQuickBarPet; class CDlgQuickPay; class CDlgRedSpark;
class CDlgRefineTrans; class CDlgReincarnation; class CDlgReincarnationBook;
class CDlgReincarnationRewrite; class CDlgReportToGM; class CDlgResetProp; class CDlgRevive;
class CDlgScriptHelp; class CDlgScriptHelpHistory; class CDlgScriptTip; class CDlgSetting;
class CDlgSettingGame; class CDlgSettingQuickKey; class CDlgSettingScriptHelp;
class CDlgSettingSystem; class CDlgSettingVideo; class CDlgShop; class CDlgShopCart;
class CDlgShopCartSub; class CDlgShopCartSubList; class CDlgSignIn;
class CDlgSimpleCostItemService; class CDlgSkill; class CDlgSkillAction; class CDlgSkillEdit;
class CDlgSkillSubAction; class CDlgSkillSubList; class CDlgSkillSubListItem;
class CDlgSkillSubListRankItem; class CDlgSkillSubOther; class CDlgSkillSubPool;
class CDlgSkillSubTree; class CDlgSkillTree; class CDlgSoloTowerChallengeAttention;
class CDlgSoloTowerChallengeAward; class CDlgSoloTowerChallengeRank;
class CDlgSoloTowerChallengeRankServices; class CDlgSoloTowerChallengeSelectLayer;
class CDlgSoloTowerChallengeSkill; class CDlgSoloTowerChallengeState; class CDlgSplit;
class CDlgStoneChange; class CDlgStoneReplace; class CDlgStoneTransfer; class CDlgStorage;
class CDlgStorageChangePW; class CDlgStoragePW; class CDlgSysModQuickBar; class CDlgSysModule;
class CDlgSystem; class CDlgSystem2; class CDlgSystem3; class CDlgSystem4; class CDlgSystem5;
class CDlgTabSetting; class CDlgTarget; class CDlgTargetItem; class CDlgTargetOfTarget;
class CDlgTask; class CDlgTaskAction; class CDlgTaskConfirm; class CDlgTaskHintPop;
class CDlgTaskList; class CDlgTaskTrace; class CDlgTeach; class CDlgTeamContext;
class CDlgTeamMain; class CDlgTeamMate; class CDlgTitleBubble; class CDlgTitleChallenge;
class CDlgTitleList; class CDlgTokenShop; class CDlgTouchShop; class CDlgTrade;
class CDlgViewModel; class CDlgVipHelp1; class CDlgVipHelp2; class CDlgWarTower;
class CDlgWebMyShop; class CDlgWebTradeBase; class CDlgWebTradeOption; class CDlgWebViewProduct;
class CDlgWedding; class CDlgWeddingInvite; class CDlgWiki; class CDlgWikiEquipment;
class CDlgWikiEquipmentDrop; class CDlgWikiItem; class CDlgWikiItemConfirm;
class CDlgWikiMonster; class CDlgWikiMonsterDrop; class CDlgWikiMonsterList;
class CDlgWikiMonsterTask; class CDlgWikiRandomProperty; class CDlgWikiRecipe;
class CDlgWikiRecipeDetail; class CDlgWikiShortcut; class CDlgWikiSkill; class CDlgWikiTask;
class CDlgWikiTaskDetail; class CDlgWorldMap;
...
public:		//	Operations
	...
	bool OnEvent_DragDrop(UINT uMsg, WPARAM wParam, LPARAM lParam, AUIDialog* pDlg, AUIObject* pObj);
	...
	bool UpdateGuide();
	void UpdateAstrolabe(S2C::cmd_astrolabe_operate_result* cmd);
	...
	void SetMarqueeMsg3(const ACHAR* pszMsg);
	...
	// ��ȡ��Ʒ�ڽ���ʱ��������ʾ��bShowFahionColor=true����ʾʱװ��ɫ��bCompareEquip=true����ʾ��ǰװ��
...
protected:
	...
	DWORD m_dwLastGTLogin;	//	�ϴε��� GT ��¼ʱ�䣨������ȴ��
	...
	//	���� PVP ���ͼ��
	enum{
		FACTION_PVP_SMALL_ICON,					//	һ��Mͼ��
		FACTION_PVP_SMALL_ICON_FOR_MY_FACTION,	//	�����һ��Mͼ��
		FACTION_PVP_NORMAL_ICON,				//	����Mͼ��
		FACTION_PVP_NORMAL_ICON_FOR_MY_FACTION,	//	���������Mͼ��
		FACTION_PVP_MINI_ICON,					//	С��ͼ��
	...
	A2DSprite*	m_pA2DSpriteFactionPVPHasMine;				//	�������п���ʾ

	CECSSOTicketHandler	*	m_ssoTicketHandler;		//	SSOGetTicket_Re Э��Ĵ���������

	bool m_bShowItemDescCompare;
	bool m_bShowLowHP;
	bool m_bShowTargetOfTarget;

	// Vip info message shown on enter world
	bool m_bVipInfoShown;
