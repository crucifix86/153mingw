...
// 	void LeaveAutoScentHostMode();
	...
	static bool IsSoloTowerChallengeMap(int worldid) { return worldid == 172 || worldid == 173 || worldid == 174 || worldid == 175; }
	bool IsSoloTowerChallengeMap()const { return IsSoloTowerChallengeMap(GetInstanceID()); }
...
// 	A3DVECTOR3	m_vHostPrevPos;
	...
	int			m_iParallelWorldID;			//	��ǰ���ڵ�ͼ�ķ��ߣ�> 0 ��Ч
