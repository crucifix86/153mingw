...
///////////////////////////////////////////////////////////////////////////
//	
//	Implement CECIvtrFirework2
//	
///////////////////////////////////////////////////////////////////////////

CECIvtrFirework2::CECIvtrFirework2(int tid, int expire_date) : CECIvtrItem(tid, expire_date)
{
	m_iCID = ICID_FIREWORK2;

	//	Get database data
	elementdataman* pDB = g_pGame->GetElementDataMan();
	DATA_TYPE DataType;
	m_pDBEssence = (FIREWORKS2_ESSENCE*)pDB->get_data_ptr(tid, ID_SPACE_ESSENCE, DataType);
...
CECIvtrFirework2::CECIvtrFirework2(const CECIvtrFirework2& s) : CECIvtrItem(s)
{
	m_pDBEssence = s.m_pDBEssence;
}

CECIvtrFirework2::~CECIvtrFirework2()
{
}

//	Set item detail information
bool CECIvtrFirework2::SetItemInfo(BYTE* pInfoData, int iDataLen)
{
	CECIvtrItem::SetItemInfo(pInfoData, iDataLen);
	return true;
}
...
//	Get item icon file name
const char* CECIvtrFirework2::GetIconFile()
{
	return m_pDBEssence->file_icon;
}

//	Get item name
const wchar_t* CECIvtrFirework2::GetName()
{
	return m_pDBEssence->name;
}

//	Get item cool time
int CECIvtrFirework2::GetCoolTime(int* piMax/* NULL */)
{
	CECHostPlayer* pHost = g_pGame->GetGameRun()->GetHostPlayer();
	return pHost ? pHost->GetCoolTime(GP_CT_FIREWORKS, piMax) : 0;
}
...
//	Get item description text
const wchar_t* CECIvtrFirework2::GetNormalDesc(bool bRepair)
{
	m_strDesc = _AL("");
...
//	Get drop model for shown
const char* CECIvtrFirework2::GetDropModel()
{
	return m_pDBEssence->file_matter;
}
...
///////////////////////////////////////////////////////////////////////////
//	
//	Implement CECIvtrOccupPackage
//	
///////////////////////////////////////////////////////////////////////////

CECIvtrOccupPackage::CECIvtrOccupPackage(int tid, int expire_date) : CECIvtrItem(tid, expire_date)
{
	m_iCID = ICID_OCCUP_PACKAGE;

	//	Get database data
	elementdataman* pDB = g_pGame->GetElementDataMan();
	DATA_TYPE DataType;
	m_pDBEssence = (ITEM_PACKAGE_BY_PROFESSION_ESSENCE*)pDB->get_data_ptr(tid, ID_SPACE_ESSENCE, DataType);
...
CECIvtrOccupPackage::CECIvtrOccupPackage(const CECIvtrOccupPackage& s) : CECIvtrItem(s)
{
	m_pDBEssence = s.m_pDBEssence;
}

CECIvtrOccupPackage::~CECIvtrOccupPackage()
{
}

bool CECIvtrOccupPackage::SetItemInfo(BYTE* pInfoData, int iDataLen)
{
	CECIvtrItem::SetItemInfo(pInfoData, iDataLen);
	return true;
}

const char* CECIvtrOccupPackage::GetIconFile()
{
	return m_pDBEssence->file_icon;
}

const wchar_t* CECIvtrOccupPackage::GetName()
{
	return m_pDBEssence->name;
}

const char* CECIvtrOccupPackage::GetDropModel()
{
	return m_pDBEssence->file_matter;
}

const wchar_t* CECIvtrOccupPackage::GetNormalDesc(bool bRepair)
{
	m_strDesc = _AL("");
...
///////////////////////////////////////////////////////////////////////////
//	
//	Implement CECIvtrFixPositionTransmit
//	
///////////////////////////////////////////////////////////////////////////

CECIvtrFixPositionTransmit::CECIvtrFixPositionTransmit(int tid, int expire_date) : CECIvtrItem(tid, expire_date)
{
	m_iCID = ICID_OCCUP_PACKAGE;
	...
	elementdataman* pDB = g_pGame->GetElementDataMan();
	DATA_TYPE DataType;
	m_pDBEssence = (FIX_POSITION_TRANSMIT_ESSENCE*)pDB->get_data_ptr(tid, ID_SPACE_ESSENCE, DataType);
...
CECIvtrFixPositionTransmit::CECIvtrFixPositionTransmit(const CECIvtrFixPositionTransmit& s) : CECIvtrItem(s)
{
	m_pDBEssence = s.m_pDBEssence;
}

CECIvtrFixPositionTransmit::~CECIvtrFixPositionTransmit()
{
}

bool CECIvtrFixPositionTransmit::SetItemInfo(BYTE* pInfoData, int iDataLen)
{
	CECIvtrItem::SetItemInfo(pInfoData, iDataLen);
	return true;
}

const char* CECIvtrFixPositionTransmit::GetIconFile()
{
	return m_pDBEssence->file_icon;
}

const wchar_t* CECIvtrFixPositionTransmit::GetName()
{
	return m_pDBEssence->name;
}

const char* CECIvtrFixPositionTransmit::GetDropModel()
{
	return m_pDBEssence->file_matter;
}

const wchar_t* CECIvtrFixPositionTransmit::GetNormalDesc(bool bRepair)
{
	m_strDesc = _AL("");
