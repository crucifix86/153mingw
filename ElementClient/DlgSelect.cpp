...
bool CDlgSelect::LoginSelectedChar(){
	...
	if( !CECCrossServer::Instance().IsWaitLogin() &&		//	��Ҫ������ɿ����¼
...
{
	ChangeFocus(NULL);	//	�������¿ؼ���ʾ˳��ı䣬Ӱ����ʾЧ��

	//	ѡ�� roleIndex ����ʾ roleIndex ����ҳ
	CECLoginUIMan* pUIMan = GetLoginUIMan();
...
bool CDlgSelect::IsCannotCreate()
{
	...
	return !g_pGame->GetGameSession()->IsConnected()
		...
		|| CECCrossServer::Instance().IsWaitLogin()		//	��������н�ɫ�б�Ϊ���п����ɫ��������������ɫ
		|| CECReconnect::Instance().IsReconnecting()	//	������Ҳ���ܴ�����ɫ
		|| CECLoginQueue::Instance().InQueue();			//	��¼�Ŷ���Ҳ����
}
