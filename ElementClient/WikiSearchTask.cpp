...
{
	CONVERT_ENTITY_PTR(WikiTaskDataProvider::Entity, p, _AL(""));
...
bool WikiSearchTaskByClassLimit::operator()(WikiEntityPtr p) const
{
	...
	unsigned long ulOccupation = min((unsigned long)MAX_OCCUPATIONS, pTempl->m_ulOccupations);
