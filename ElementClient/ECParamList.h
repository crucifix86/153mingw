...
// Forward declare the Param specializations outside the class for GCC compatibility
namespace ECParamListDetail
{
...
{
private:
	using ParamBase = ECParamListDetail::ParamBase;
	template<typename T> using Param = ECParamListDetail::Param<T>;
