...
public:
	enum
	{
		MOD_PHYSIC_ATTACK_RUNE	= 0x0001,		//	���������Ż�����Ч
		MOD_MAGIC_ATTACK_RUNE	= 0x0002,		//	���������Ż�����Ч
		MOD_PHYSIC_DEFENCE_RUNE = 0x0004,		//	���������Ż�����Ч
		MOD_MAGIC_DEFENCE_RUNE	= 0x0008,		//	���������Ż�����Ч
		MOD_CRITICAL_STRIKE		= 0x0010,		//	����
		MOD_RETORT				= 0x0020,		//	����
		MOD_NULLITY				= 0x0040,		//	��Ч����
		MOD_IMMUNE				= 0x0080,		//	�����˴˴ι��������ȼ�������Ч
		MOD_ENCHANT_FAILED		= 0x0100,		//	enchant ʧ��
		MOD_SUCCESS				= 0x0200,		//	�ɹ�
		MOD_DODGE_DAMAGE		= 0x0400,		//  �˺�����
		MOD_DODGE_DEBUFF		= 0x0800,		//  ״̬����
		MOD_ATTACK_AURA			= 0x1000,		//  �⻷����
		MOD_REBOUND				= 0x2000,		//  ����
...
protected:
	...
	struct SkillStateAction
	{
		int skill;
		int state;
		AString beHitAction; // �����ж���
		AString stayDownAction;//���ڵ��ϵĶ���
	};
...
{
public:
	typedef abase::hash_map<AString, A3DSkillGfxComposer*> SgcName2ComposerMap; // ���ڶ�μ��ܵ�sgc����
