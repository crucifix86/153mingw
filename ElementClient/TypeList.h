...
{
	typedef typename TTypeList::Tail Tail;
	typedef TypeList<const typename TTypeList::Head *, typename TypeList2ConstPtrTypeList<Tail>::Result> Result;
};
...
namespace Private
{
	...
	struct HeadSubTypeListHelper
	{
		...
		struct In
		{
			typedef typename TTypeList::Head Head;
			typedef typename TTypeList::Tail Tail;
			typedef TypeList<Head, typename HeadSubTypeListHelper<HeadN - 1>::template In<Tail>::Result> Result;
		};
	};
