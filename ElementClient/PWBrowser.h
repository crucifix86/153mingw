...
// MinGW doesn't have ATL, use stub implementation
#if defined(__GNUC__) || defined(__MINGW32__)
#include "PWBrowser_mingw.h"
#else
...
public:
	...
	// ��̬���ӿ���ñ����ṩDLLģ��� hinstance
	BOOL InitContainer(HINSTANCE hInstance);
	// EXE�����粻�ṩ hinstance������GetModuleHandle(NULL) ��ȡ
	BOOL InitContainer();
	...
	void SetActive(bool bActive)
	{
		...
		m_dwTransparent =bActive?m_dwTransparentconstant:0;
		{
			...
			My_SetLayeredWindowAttributes(m_hWnd,colork,m_dwTransparent,LWA_ALPHA);//��������������Ż��д�����ʾ
		}
		ReleaseMutex(m_hUrlMutex);
	}
...
private:
	...
	BYTE         m_dwTransparentconstant; //���ݷֱ��ʼ�����С��transparent λ�� //16λɫ��5�� 32 λɫ��1
...
public:
	...
	void _stdcall OnBeforeNavigate2( IDispatch** ppDisp, VARIANT* pvUrl, VARIANT*Flags, VARIANT* pvTarget, VARIANT*PostData, VARIANT*Headers, VARIANT_BOOL *pbCancel)
	{
		...
		if (pvUrl->bstrVal && wcscmp(pvUrl->bstrVal, L"javascript:void(0)") == 0)
		{
