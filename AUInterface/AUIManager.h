...
struct FONT_PARAM
{
	FONT_PARAM()
	{
		// Default font - use SimSun (Chinese) or Arial as fallback
		szFontName = _AL("SimSun");
		nFontSize = 10;
		bBold = false;
		bItalic = false;
		bFreeType = true;
...
protected:
	...
	// ����UIӦ�ò��õ����ű���,ResizeWindowʱ���Զ����ô˺���
	// ���������������Ӧ��ͬ����Ϸ���ڴ�С����������������ű���
	virtual void CalcWindowScale();

	// ����pszTempName(.dtf�ļ���)�ڶ��ϴ��������Dialog����
	// ���Ҫʹ��AUIManager���Զ�����Dialog����(��.dcf�ļ�����)��
	// �������������Ϊ��ͬ��.dtf�ļ������ʵ���Dialog���󣬵�
	// �ǵ�Ĭ��Ҫ����AUIDialog�����Լ�����ǰ�Ĵ���
