...
public:
	...
	// ֻ��bShowΪtrueʱ��param��������
	virtual void Show(bool bShow, bool bModal = false, bool bActive = true, bool bFocusLock = true);
