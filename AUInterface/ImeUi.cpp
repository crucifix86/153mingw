...
public:
	...
	void Initialize()
	{
		...
		{
			//XP ϵͳtsf֧�ֲ��ã��ر��ض���tsf���ܣ�ǿ�����뷨��imm����
...
// For older MSVC versions which lack these TSF interface definitions
// MinGW has these in msctf.h, so skip for __GNUC__
...
// These are already defined in MinGW's msctf.h
#ifndef __TF_INPUTPROCESSORPROFILE_DEFINED__
...
// These interfaces are not in MinGW's msctf.h, define them for MinGW
#if defined(__GNUC__) && !defined(__ITfReadingInformationUIElement_INTERFACE_DEFINED__)
...
#if defined(__GNUC__) && !defined(__ITfCandidateListUIElement_INTERFACE_DEFINED__)
...
// For MinGW, define the IIDs for TSF interfaces since __uuidof() doesn't work properly
#if defined(__GNUC__) && !defined(_MSC_VER)
static const IID IID_ITfReadingInformationUIElement = {0xEA1EA139, 0x19DF, 0x11D7, {0xA6, 0xD2, 0x00, 0x06, 0x5B, 0x84, 0x43, 0x5C}};
static const IID IID_ITfCandidateListUIElement = {0xEA1EA138, 0x19DF, 0x11D7, {0xA6, 0xD2, 0x00, 0x06, 0x5B, 0x84, 0x43, 0x5C}};
// Override __uuidof for these types
#define __uuidof(T) IID_##T
#endif

// Define missing constants for MinGW
#ifndef TF_SFT_DESKBAND
#define TF_SFT_DESKBAND 0x0800
#endif
#ifndef TF_SFT_HIDDEN
#define TF_SFT_HIDDEN 0x0008
#endif
