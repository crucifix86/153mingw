...
// Font face name mappings - Chinese FangZheng fonts
// Original names: 方正兰亭粗黑简体, 方正细黑一简体, 方正兰亭黑简体
static _face_path_pair _font_inner_map[] =
{
	{ L"\x65B9\x6B63\x5170\x4EAD\x7C97\x9ED1\x7B80\x4F53",		"font\\FZL2JW.ttf" },
	{ L"\x65B9\x6B63\x7EC6\x9ED1\x4E00\x7B80\x4F53",	"font\\FZXH1JW.ttf" },
	{ L"\x65B9\x6B63\x5170\x4EAD\x9ED1\x7B80\x4F53",		"font\\FZLBJW.ttf" }
};
...
// Default font: 方正细黑一简体
static const wchar_t* _default_font_face = L"\x65B9\x6B63\x7EC6\x9ED1\x4E00\x7B80\x4F53";
...
bool A3DFTFontMan::Create(A3DDevice* pDevice, const char* szConfigFile)
{
	...
	if (af_IsFileExist(_stereo_shadow))
		m_pStereoShadowShader = m_pDevice->GetA3DEngine()->GetA3DShaderMan()->LoadVertexShader(_stereo_shadow, false, dwVSDecl2);
	else
