...
bool AUITreeView::OnDlgItemMessage(UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	int nItemIndent = max(1, (int)((m_nItemIndent + m_nTextIndent) * fWindowScale));
	int nItemHeight = max(1, (int)(m_nItemHeight + m_nLineSpace * fWindowScale));
...
bool AUITreeView::Resize()
{
	...
	m_nItemHeight = max(nTextH, (int)(nIconH*fWindowScale));	
