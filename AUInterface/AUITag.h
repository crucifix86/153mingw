...
typedef struct _TAG_RESOLVER_CONTEXT
{
	...
	int			nCurY;
	bool		bExceedBottom;
	bool		bRotateLayout; // ���ڴ�ֱ��ʾ�������Ӣ�ģ�����ת��ʾ
...
// Forward declarations - AUITagRegister and AUITagUnregister moved below AUIRichTextPrinter
...
public:
	...
	void RegisterTagtype(const AUITextTag& tg);
	bool UnRegisterTagType(const AUITextTag& tg);
...
protected:
	...
	void RegisterTagtypeBuiltIn(const AUITextTag& tg);
