...
// Define the GUID for CLSID_SurfaceRenderer directly
// {75277FF8-6E80-4850-BD0A-E9D1CCECDFB9}
// Use static const GUID to ensure the symbol is defined here
static const GUID GUID_SurfaceRenderer = { 0x75277FF8, 0x6E80, 0x4850, {0xBD, 0x0A, 0xE9, 0xD1, 0xCC, 0xEC, 0xDF, 0xB9} };

AMSurfaceRenderer::AMSurfaceRenderer(LPUNKNOWN pUnk, HRESULT *phr)
                                   : CBaseVideoRenderer(GUID_SurfaceRenderer,
