...
public:		//	Operations
	...
	//	Add a element at end of array (const ref to allow rvalue binding)
	int	Add(const T& Elem);
	//	Add a element ensuring there isn't collision
	int UniquelyAdd(const T& Elem);
	//	Insert elements
	void InsertAt(int iIndex, const T& Elem, int iCount=1);
	...
	//	Set element at specified position (always use const ref to allow rvalue binding)
	void SetAt(int iIndex, const T& Elem) { (*this)[iIndex] = Elem; }
	//	Get element at specified position
	T GetAt(int iIndex) const { return (*this)[iIndex]; }
	//	Set element at specified position, grow array if necessary
	void SetAtGrow(int iIndex, const T& Elem);

	//	Find an element
	int Find(const T& Elem);
	//	Reverse find an element
	int ReverseFind(const T& Elem);
	...
	int capacity () { return m_iMaxElem; }
...
*/
template <class T, class ARG_T>
int AArray<T, ARG_T>::UniquelyAdd(const T& Elem)
{
...
*/
template <class T, class ARG_T>
void AArray<T, ARG_T>::InsertAt(int iIndex, const T& Elem, int iCount/* 1 */)
{
	ASSERT(iIndex >= 0);
...
*/
template <class T, class ARG_T>
void AArray<T, ARG_T>::SetAtGrow(int iIndex, const T& Elem)
{
	ASSERT(iIndex >= 0);
...
//	Find an element
template <class T, class ARG_T>
int AArray<T, ARG_T>::Find(const T& Elem)
{
	for (int i=0; i < m_iNumElem; i++)
	{
		if (m_aElements[i] == Elem)
...
//	Reverse find an element
template <class T, class ARG_T>
int AArray<T, ARG_T>::ReverseFind(const T& Elem)
{
