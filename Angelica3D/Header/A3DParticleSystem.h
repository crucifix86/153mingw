...
public:
	...
	bool UpdateParentTM(const A3DMATRIX4& matParent);
...
public:
	...
	inline void SetTextureMap(char * pszTextureMap) { strncpy(m_szTextureMap, pszTextureMap, MAX_PATH); }
	...
	inline void SetScale(FLOAT vScale) { m_vScale = vScale; m_vSpeedScale = (float)a_FastSqrt(m_vScale); }
