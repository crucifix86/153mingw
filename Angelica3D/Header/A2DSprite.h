...
public:
	...
	bool UpdateTextures(BYTE* pDataBuffer, DWORD dwPitch, A3DFORMAT format);
...
public:
	...
	bool DrawToBack(long x, long y) { return DrawToBack((float)x, (float)y); }
	...
	bool DrawToBuffer(A2DSpriteBuffer * pSpriteBuffer, long x, long y) { return DrawToBuffer(pSpriteBuffer, (float)x, (float)y); }
	...
	bool DrawToInternalBuffer(long x, long y) { return DrawToInternalBuffer((float)x, (float)y); }
