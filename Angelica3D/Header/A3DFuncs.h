...
inline FLOAT a3d_Magnitude(const A3DVECTOR3& v) { return (FLOAT)(v.Magnitude()); /*sqrt(v.x * v.x + v.y * v.y + v.z * v.z));*/ }
inline FLOAT a3d_MagnitudeH(const A3DVECTOR3& v) { return (FLOAT)(v.MagnitudeH());/*sqrt(v.x * v.x + v.z * v.z));*/ }
...
//	Build vertex shader declarator used by morph meshes
...
inline void AddVertexToAABB(A3DVECTOR3& vMins, A3DVECTOR3& vMaxs, const A3DVECTOR3& vPoint) { a3d_AddVertexToAABB(vMins, vMaxs, vPoint); }
