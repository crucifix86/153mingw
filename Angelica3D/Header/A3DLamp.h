...
public:		//	Operations
	...
	inline void	SetLampParams(FLOAT fWidth, FLOAT fHeight, const A3DVECTOR3& vPos, const A3DVECTOR3& vDir, A3DCOLOR Color);		//	Set lamp parameters
...
/*	Set lamp parameters.
	...
	Color: lamp's color.
*/
void A3DLamp::SetLampParams(FLOAT fWidth, FLOAT fHeight, const A3DVECTOR3& vPos,
							const A3DVECTOR3& vDir, A3DCOLOR Color)
{
	m_fWidth	= fWidth;
	m_fHeight	= fHeight;
	m_vLampPos	= vPos;
