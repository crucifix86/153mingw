...
// Prevent Windows.h from defining min/max that conflict with STL
#ifndef NOMINMAX
#define NOMINMAX
#endif
...
// DO NOT define min/max macros - they break STL headers
// CxImage code should use cxmin/cxmax instead
#ifdef __cplusplus
template<typename T, typename U>
inline T cxmin(T a, U b) { return (a < (T)b) ? a : (T)b; }
template<typename T, typename U>
inline T cxmax(T a, U b) { return (a > (T)b) ? a : (T)b; }
#else
