...
bool A3DGFXECModel::Play()
{
	...
	//////////////////////////////////////////////////////////////////////////
	// �������ͼ�ǣ���һ��Playʱ������ģ�ͣ�������һЩ��ʼ������(��Loader��OnInit��)
	// Ȼ�󷴸��ĵ���Play��Stop�����ᵼ��ģ�͵����¼���
	// ���ǿ��ܴ������⣺
	// �����Gfx��CacheRelease�ˣ�Ȼ���ֱ�Load���������������Gfx��û�б������ͷţ������IsInit�жϻ���Ϊ��
	// ���ǣ�InitModelFile�������ᱻ���ã���ĳЩ���ϴ��ڳ�������Ŀ��ܣ�
	// �����Load������Gfx����������ĳ��ECModel����Model��һЩ��Ҫ���ݵ�����(GFXUseLod, GfxShakeCam)���ø���Gfx
	// ���ǣ���ʱ���޷���Gfx�ϸı��˵ļ̳������ύ���²��ECModel�ˣ������Ҫ�����޸ģ�
	// ��ÿ��OnPlay��ʱ�򶼰Ѽ̳е����Դ���һ��
	//////////////////////////////////////////////////////////////////////////
	...
	if (m_pECModel)
	{
		...
		{
			m_pECModel->PlayActionByName(m_strActionName, 1.0f);
		}
	}
...
void A3DGFXECModel::UpdateECModel(A3DMATRIX4 matTran, DWORD dwDiffuse, DWORD dwTickTime)
{
	...
	if (!m_pECModel->IsLoaded() || !m_pECModel->GetA3DSkinModel())
		return;
