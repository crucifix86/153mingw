...
bool Event::Load(AFileImage* pFile)
{
	...
	for (int i=0; i<iParamNum; ++i)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::Load ����EventParameter:%sʧ��", pEventParameter->GetName());
			delete pEventParameter;
			return false;
		}
		pEventParameter->SetEvent(this);
	...
	for (int i=0; i<iLayerNum; ++i)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::Load ����EventLayer:%sʧ��", pEventLayer->GetName());
			delete pEventLayer;
			return false;
		}
		m_listEventLayer.push_back(pEventLayer);
...
bool Event::Save(AFile* pFile)
{
	...
	for (; itParam!=m_listEventParameter.end(); ++itParam)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::Save ����EventParameter:%sʧ��", pEventParameter->GetName());
			return false;
		}
	}
	...
	for (; itLayer!=m_listEventLayer.end(); ++itLayer)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::Save ����EventLayer:%sʧ��", pEventLayer->GetName());
			return false;
		}
	}
...
bool Event::LoadXML(TiXmlElement* root, bool bPreset /*= false*/)
{
	...
	for (int i=0; i<iParamNum; ++i)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::LoadXML ����EventParameter:%sʧ��", pEventParameter->GetName());
			delete pEventParameter;
			return false;
		}
		pEventParameter->SetEvent(this);
	...
	for (int i=0; i<iLayerNum; ++i)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::LoadXML ����EventLayer:%sʧ��", pEventLayer->GetName());
			delete pEventLayer;
			return false;
		}
		m_listEventLayer.push_back(pEventLayer);
...
bool Event::SaveXML(TiXmlElement* pParent, bool bPreset /*= false*/)
{
	...
	for (; itParam!=m_listEventParameter.end(); ++itParam)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::SaveXML ����EventParameter:%sʧ��", pEventParameter->GetName());
			return false;
		}
	}
	...
	for (; itLayer!=m_listEventLayer.end(); ++itLayer)
	{
		...
		{
			m_pEventProject->GetEventSystem()->GetLogManager()->GetEngineLog()->Write(LOG_ERROR, "Event::SaveXML ����EventLayer:%sʧ��", pEventLayer->GetName());
			return false;
		}
	}
