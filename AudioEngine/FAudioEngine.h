...
namespace AudioEngine
{
	...
	typedef enum
	{
		STOP_MODE_CUTOFF,				// ֹͣʱ����ֹͣ
		STOP_MODE_PLAYTOEND				// ֹͣʱ�����굱ǰ��Ƶ��ֹͣ
	}STOP_MODE;
	...
	typedef enum
	{
		START_MODE_IMMEDIATE,				// ������ʼ����
		START_MODE_WAIT_FOR_PREVIOUS		// �ȴ�ǰһ����������ٿ�ʼ����
	}START_MODE;

	struct SOUND_INSTANCE_PROPERTY
	{
		float		fStartPosition;			// ��ʼ��[0,1]�����EventParameter
		float		fLength;				// ����[0,1]�����EventParameter
		START_MODE	startMode;				// ��ʼģʽ
		STOP_MODE	stopMode;				// ѭ��ģʽ
		int			iLoopCount;				// ѭ��������Ĭ��Ϊ1
		PLAY_NUM	playNum;				// ÿ�β����ļ�������һ������ȫ�������ղ���ģʽ����X��
		int			iFadeInTime;
		int			iFadeInCurveType;
		int			iFadeOutTime;
		int			iFadeOutCurveType;
		int			iPreIntervalTime;			// ǰ��ʱ����[0,1200]s��Ĭ��0
		int			iPreIntervalTimeRandomization;	// ǰ��ʱ�������[0,1200]s��Ĭ��0
