...
// MinGW SAL annotation compatibility
#ifndef _MSC_VER
#include "sal_fix.h"
#endif
...
#endif
#else
// MinGW/GCC - define AM_NOVTABLE as empty
#define AM_NOVTABLE
#endif	// MSC_VER
...
// Re-include sal_fix.h after windows headers for SAL annotations and dshow compat
#ifndef _MSC_VER
#include "sal_fix.h"
#include "dshow_compat.h"
// Use std::min/max from algorithm header
#include <algorithm>
using std::min;
using std::max;
#endif
