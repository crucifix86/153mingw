...
#define AFPCK_VERSION		0x00020003	//	The version with safe header
...
public:
	...
	// Enable/disable WinPCK backend
	void UseWinPCKBackend(bool bEnable) { m_bUseWinPCK = bEnable; }
	bool IsUsingWinPCK() const { return m_bUseWinPCK; }
